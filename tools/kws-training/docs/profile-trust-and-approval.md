...
Owner evidence-reference decision recorded for `TRUST-APP-01`:

```text
owner: loidinhm31
recorded_at: 2026-08-19 (Asia/Ho_Chi_Minh)
evidence_references: opaque controlled IDs
example: EVID-2026-001
stored_content: no paths; URLs; raw audio; or private locations
